from agent.browser import (
    type_and_enter, type, click_element, hover_element,
    go_to_url, go_back, go_forward, refresh,
...
class AgentBrowser:
    ...
    async def launch(self, url: str = "https://google.com", headless: bool = False) -> Tuple[BrowserContext, Page]:
        ...
        self.context = await self.browser.new_context(no_viewport=True, user_agent=user_agent)
        self.page = await self.context.new_page()
        print("User Agent:", await self.page.evaluate("() => navigator.userAgent"))
